...
define(function(require, exports) {
    ...
    return {
        ...
        setBetRegion: function(){
			...
			$('#pullSelect').height(winH - botH  - issueH  + 'px');
			$('#guide').height(winH - botH - issueH - 14 + 'px');
			_.delay(function(){
				$('#pullSelect').css('left','0');
				if(C.Config.platform === 'ios' || (C.Config.platform === 'android' && device.version == '4.0.4') || (C.Config.platform === 'android' && device.version == '2.2')){
					return;
				}
				$('#bottom').css('top',$('#pullSelect').height() + issueH + 'px');
			},300);
