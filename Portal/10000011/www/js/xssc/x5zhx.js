...
define(function(require,exports){
	...
	var collectionConfig = function(){
		return {
			lines: 5,
			key: 'xssc_x5zhx',
			localStorage: new Store('xsscx5zhxball'),
			deviation: 0,
			/**
			 * 验证是否符合此玩法的选号规则
	...
	return {
		initialize: function(isManualFirst){
			...
			C.xsscx5zhxballcollection = new Ball.Collection(collectionConfig());
			Tool.detectLocalData('xsscx5zhxball',C.xsscx5zhxballcollection);
			C.xsscx5zhxballapp = new Ball.App(appConfig(isManualFirst,C.xsscx5zhxballcollection));
		}
	};
});